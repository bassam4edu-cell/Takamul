    ...
    <div className="min-h-screen bg-[#f8fafc] relative overflow-hidden font-['Tajawal']" dir="rtl">
      ...
      <main className="relative min-h-screen flex flex-col items-center justify-center px-4 md:px-6 py-24 md:py-20 z-10">
        ...
        >
          ...
          {/* Buttons Container */}
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 w-full max-w-2xl pt-4 md:pt-8">
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full md:flex-1 bg-white text-slate-800 border-2 border-slate-100 py-5 md:py-6 px-6 md:px-8 rounded-2xl md:rounded-[2rem] font-bold text-lg md:text-xl shadow-xl shadow-slate-200/50 flex items-center justify-center gap-3 hover:border-emerald-500/30 hover:text-emerald-700 transition-all group"
            >
              <span className="w-8 h-8 md:w-10 md:h-10 bg-emerald-50 text-emerald-600 rounded-lg md:rounded-xl flex items-center justify-center group-hover:bg-emerald-600 group-hover:text-white transition-colors">
            ...
            <motion.button
              ...
              whileHover={{ y: -5, scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full md:flex-1 bg-slate-900 text-white py-5 md:py-6 px-6 md:px-8 rounded-2xl md:rounded-[2rem] font-bold text-lg md:text-xl shadow-2xl shadow-slate-900/20 flex items-center justify-center gap-3 hover:bg-emerald-700 transition-all group"
            >
              <span className="w-8 h-8 md:w-10 md:h-10 bg-white/10 text-white rounded-lg md:rounded-xl flex items-center justify-center group-hover:bg-white group-hover:text-emerald-700 transition-colors">
